  ...
  return (
    <div className={styles.bgTexture}>
        ...
        <div className={styles.contentWrap}>
          <div className={styles.textBox}>
            ...
            <p className={`${styles.subtitle} ${roboto.className}`}>
              Otkrijte čaroliju prirodnih čajeva koji donose mir, zdravlje i toplinu u svaki trenutak. 
              Od planina Bosne do vaše šoljice - autentičan ukus i blagotvornost u svakom gutljaju.
            </p>
      ...
      <section className={styles.benefitsSection}>
        ...
        <div className={styles.benefitsText}>
          ...
          <p className={`${styles.benefitsDesc} ${roboto.className}`}>
            ...
            Čaj od mente osvježava i doprinosi lakšem disanju. Posebno je cijenjen za olakšavanje probavnih tegoba poput nadutosti, mučnine i grčeva.
          </p>
          ...
          <Button
            ...
            height="45px"
            rounded="25px"
            ariaLabel="Saznaj više o prednostima"
      ...
      <section className={styles.whyusContainer}>
        ...
        <p className={`${styles.whyusText} ${roboto.className}`}>
          Kao mali porodični biznis, posvećeni smo kvaliteti i iskrenom pristupu. 
          Svaki naš čaj nastaje s pažnjom, od prirodnih sastojaka, a naši kupci su uvijek na prvom mjestu. 
          Kod nas dobijaš proizvode iza kojih stoji ljubav, tradicija i briga.
        </p>
        ...
        <div className={styles.productsContainer}>
          <div className={styles.productsSubContainer}>
            ...
            <div className={styles.productPhotos}>
              <div 
                className={styles.productPhotosSubContainer}
                onClick={() => router.push("/caj/kamilica")}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
                  if (e.key === "Enter" || e.key === " ") {
                    router.push("/caj/kamilica");
                  }
                }}
              >
                <div className={styles.productPhoto}></div>
                <p className={`${styles.productName} ${roboto.className}`}>Kamilica</p>
              </div>
              <div 
                className={styles.productPhotosSubContainer}
                onClick={() => router.push("/caj/menta")}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
                  if (e.key === "Enter" || e.key === " ") {
                    router.push("/caj/menta");
                  }
                }}
              >
                <div className={styles.productPhoto2}></div>
                <p className={`${styles.productName} ${roboto.className}`}>Menta</p>
              </div>
              <div 
                className={styles.productPhotosSubContainer}
                onClick={() => router.push("/caj/sipak")}
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
                  if (e.key === "Enter" || e.key === " ") {
                    router.push("/caj/sipak");
                  }
                }}
              >
                <div className={styles.productPhoto3}></div>
                <p className={`${styles.productName} ${roboto.className}`}>Šipak</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className={styles.iconsSection}>
        <div className={styles.iconsColumn}>
          ...
          <div className={styles.iconItem}>
            ...
            <p className={roboto.className}>Slanje Širom Bosne</p>
          </div>
      ...
      <section className={styles.gallery}>
        <h4 className={roboto.className}>NAŠA GALERIJA</h4>
        <h2 className={philosopher.className}>Uvjerite Se Da Smo Stvarno Najbolji</h2>
